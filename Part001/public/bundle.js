...
var Level = /** @class */ (function (_super) {
        ...
        if (GameProperties_1.GameProperties.InGame) {
            ...
            if (pointer.isDown) {
                if (PlayerHelper_1.PlayerHelper.DistanceToPointer(this._player, pointer) <= 50) {
                    PlayerHelper_1.PlayerHelper.MoveToPointer(this._player, 0, pointer, 500);
                }
                else {
                    PlayerHelper_1.PlayerHelper.MoveToPointer(this._player, 500, pointer, 500);
                }
    ...
    Level.prototype.OnNewPlayer = function (data) {
        // Enemy object
        var newEnemy = new RemotePlayer_1.RemotePlayer(data.id, data.x, data.y, data.username, data.angle, this);
...
},{"./GameProperties":2,"./PlayerHelper":4,"./RemotePlayer":5,"socket.io-client":41}],4:[function(require,module,exports){
"use strict";
/// <reference path="./libs/phaser.d.ts" />
Object.defineProperty(exports, "__esModule", { value: true });
...
var RemotePlayer = /** @class */ (function () {
    function RemotePlayer(id, startX, startY, username, startAngle, state) {
        this.id = id;
        this.x = startX;
        this.y = startY;
...
},{"base64-js":11,"ieee754":34}],15:[function(require,module,exports){
/**
 * Slice reference.
 */
...
},{"./transport":20,"./transports/index":21,"component-emitter":16,"debug":27,"engine.io-parser":29,"indexof":35,"parseqs":38,"parseuri":39}],20:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":20,"component-inherit":17,"debug":27,"engine.io-parser":29,"parseqs":38,"xmlhttprequest-ssl":26,"yeast":54}],25:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":20,"component-inherit":17,"debug":27,"engine.io-parser":29,"parseqs":38,"ws":13,"yeast":54}],26:[function(require,module,exports){
(function (global){
...
},{"./keys":30,"./utf8":31,"after":7,"arraybuffer.slice":8,"base64-arraybuffer":10,"blob":12,"has-binary2":32}],30:[function(require,module,exports){
...
},{"buffer":14,"isarray":36}],33:[function(require,module,exports){
...
},{"./manager":42,"./socket":44,"./url":45,"debug":46,"socket.io-parser":49}],42:[function(require,module,exports){
...
},{"./on":43,"./socket":44,"backo2":9,"component-bind":15,"component-emitter":16,"debug":46,"engine.io-client":18,"indexof":35,"socket.io-parser":49}],43:[function(require,module,exports){
...
},{"./on":43,"component-bind":15,"component-emitter":16,"debug":46,"has-binary2":32,"parseqs":38,"socket.io-parser":49,"to-array":53}],45:[function(require,module,exports){
(function (global){
...
},{"./debug":47,"_process":40}],47:[function(require,module,exports){
arguments[4][28][0].apply(exports,arguments)
},{"dup":28,"ms":37}],48:[function(require,module,exports){
(function (global){
/*global Blob,File*/
...
},{"./binary":48,"./is-buffer":50,"component-emitter":16,"debug":51,"isarray":36}],50:[function(require,module,exports){
(function (global){
...
arguments[4][28][0].apply(exports,arguments)
},{"dup":28,"ms":37}],53:[function(require,module,exports){
